 ...
 */
router.post(
  '/connections/:connectionId/query/metrics',
  async (req: Request, res: Response): Promise<void> => {
    try {
      const { connectionId } = req.params;
 ...
 */
router.post(
  '/connections/:connectionId/transaction/begin',
  async (req: Request, res: Response): Promise<void> => {
    try {
      const { connectionId } = req.params;
 ...
 */
router.post(
  '/connections/:connectionId/transaction/commit',
  async (req: Request, res: Response): Promise<void> => {
    try {
      const { connectionId } = req.params;
 ...
 */
router.post(
  '/connections/:connectionId/transaction/rollback',
  async (req: Request, res: Response): Promise<void> => {
    try {
      const { connectionId } = req.params;
