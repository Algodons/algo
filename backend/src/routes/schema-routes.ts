 ...
 */
router.post(
  '/connections/:connectionId/schema/tables',
  async (req: Request, res: Response): Promise<void> => {
    try {
      const { connectionId } = req.params;
 ...
 */
router.delete(
  '/connections/:connectionId/schema/tables/:tableName',
  async (req: Request, res: Response): Promise<void> => {
    try {
      const { connectionId, tableName } = req.params;
 ...
 */
router.post(
  '/connections/:connectionId/schema/tables/:tableName/indexes',
  async (req: Request, res: Response): Promise<void> => {
    try {
      const { connectionId, tableName } = req.params;
 ...
 */
router.delete(
  '/connections/:connectionId/schema/tables/:tableName/indexes/:indexName',
  async (req: Request, res: Response): Promise<void> => {
    try {
