...
This repository uses Snyk for comprehensive security scanning of dependencies,
container images, and source code. The Snyk workflow has been configured but
requires a secret token to function properly.
...
After adding the secret, the Snyk workflow will be able to authenticate
properly. You can verify by:
...
- Automatically scans `package.json` and `package-lock.json` for vulnerable
  dependencies
...
- The SARIF file is now automatically generated with
