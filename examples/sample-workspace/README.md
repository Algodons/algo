...
This is a sample workspace to demonstrate the Cloud IDE platform's capabilities.

## What's Included

- `index.html` - Main HTML file with feature overview
- `styles.css` - Stylesheet with modern design
- `script.js` - Interactive JavaScript demo
- `README.md` - This file
